...
void callback(char* topic, byte* payload, unsigned int length) {  
  ...
  if(topic1 == "Temp_AES128"){
    key = "abcdefghijklmnop";
  }
  else if(topic1 == "FlameAlarm_AES192"){
    key = "abcdefghijklmnopqrstuvwx";
  }
  else if(topic1 == "Motion_AES256"){
...
void loop() {
  ...
  if (now - lastMsg > 2000) {
    ...
    if(client.subscribe("Temp_AES128",0) == true){// subscribe Topic and returns true upon success
      //Serial.println("\nSubscribe Success!");
    }
    else{
      //Serial.println("\nSubscribe Failed!");
    ...
    if(client.subscribe("FlameAlarm_AES192",0) == true){// subscribe Topic and returns true upon success
      //Serial.println("\nSubscribe Success!");
    }
    else{
      //Serial.println("\nSubscribe Failed!");
    ...
    if(client.subscribe("Motion_AES256",0) == true){// subscribe Topic and returns true upon success
      //Serial.println("\nSubscribe Success!");
    }
    else{
      //Serial.println("\nSubscribe Failed!");
